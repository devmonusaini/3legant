          ...
          {slides.map((slide) => (
            ...
            >
              ...
              <div className="relative w-full h-[300px] md:h-[349px] flex items-center justify-center overflow-hidden bg-[#F3F5F7] group rounded-lg">
                ...
                <img
                  src={slide.img}
                  alt={`Product ${slide.id + 1}`}
                  className="w-full h-full object-cover scale-[1.05]"
                />

                {/* Add to Cart Button */}
                <div className="w-[calc(100%-32px)] absolute bottom-6 left-4 z-10 bg-secondary text-primary text-center rounded-lg font-medium py-2 md:py-3 px-4 cursor-pointer 
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-secondary mt-1">$49.99</p>
              </div>
            </div>
          ))}
        </div>
